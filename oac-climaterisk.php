...
class OACClimateRisk {
  ...
  public static function initialize() {
    ...
    load_plugin_textdomain( 'oac_climaterisk', null, self::$plugin_dir . '/languages' );
    $filter = null;
  ...
  public static function ui_panel()  {
    ...
    $output .= '<img src="' . self::$plugin_url . '/css/images/RAIN.PNG" id="cropImg" class="cropImg">';
  ...
  public static function tabs() {
    ...
    <div id="tabs" class="tabs">
      <ul>
ENDTABS;
    $output .= '<li><a href="#tabs-1">'.__( 'Average &amp; Deviation', 'oac_climaterisk' ).'</a></li>';
    $output .= '<li><a href="#tabs-2">'.__( 'Probability Distribution', 'oac_climaterisk' ).'</a></li>';
    $output .= '<li><a href="#tabs-3">'.__( 'Probability of Exceedance', 'oac_climaterisk' ).'</a></li>';
    $output .= '<li><a href="#tabs-4">'.__( 'Last 5 Years', 'oac_climaterisk' ).'</a></li>';
    $output .= <<<ENDTABS
      </ul>
...
ENDTABS;
  ...
  public static function hijack_header() {
    ...
    if ((isset( $matches[2])) && ($matches[2] == 'oac_climaterisk')) {
      wp_enqueue_style( 'oacclimaterisk', plugins_url( 'css/oac-climaterisk.css', __FILE__ ), array( 'oacbase', 'oacjqueryui' ) );
      wp_register_script( 'oac_climaterisk', plugins_url( 'js/oac-climaterisk.js', __FILE__ ),
        array( 'oac-base', 'underscore', 'jquery-ui-core', 'jquery-ui-tabs', 'grbar', 'grline' ) //, 'oac-barchart', 'oac-linechart' )
      );
